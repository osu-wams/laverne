...
class LaverneCheckOwnerCommand extends Command {
   ...
   * @param string $url The URL used as a condition to filter query results.
   *
   * @return RowsOfFields A collection of rows containing the retrieved fields.
   */
  public function doExecute(InputInterface $input, OutputInterface $output, string $url): RowsOfFields {
  ...
  /**
   * Configures the command by defining its arguments and options.
   *
   * @return void
   */
